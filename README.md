...
* Arduino Nano V3.0
* NodeMcu v3 для выхода в интернет. Обратите внимание, что китайские платы бывают разных размеров. Нужно покупать такие, как на фото вверху. 
...
Сигнализация позволяет использовать два любых пина для управдения реле, которые будет включать звуковую сирену или световую сигнализацию в случае тревоги.
