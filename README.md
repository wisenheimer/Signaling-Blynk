...
![18](https://user-images.githubusercontent.com/45194485/56153559-21aeb200-5fbf-11e9-9193-cdd780751d35.jpg)

Это данные вашей точки доступа Wi-Fi и токен Blynk. Сейчас эти поля пустые. Вам нужно записать данные в память микроконтроллера.
...
При загрузке модем SIM800L определяет оператора свзязи и отправляет в порт его имя, которе можно посмотреть в терминале в режиме отладки. Например
